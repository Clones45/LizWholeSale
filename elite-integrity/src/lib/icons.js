// icons.js — Lucide-style thin-stroke SVG icon library (1.25px stroke)
// All icons are monochromatic, inherit color via currentColor
...
const PATHS = {
  ...
  'phone':         `<path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.41a2 2 0 0 1 1.99-2.18h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L7.91 9.91a16 16 0 0 0 6.06 6.06l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/>`,
  ...
  'balance':       `<line x1="12" y1="3" x2="12" y2="21"/><path d="M3 9h9l-4.5 8.5L3 9z"/><path d="M21 9h-9l4.5 8.5L21 9z"/>`,
  'package':       `<line x1="16.5" y1="9.4" x2="7.5" y2="4.21"/><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/>`,
};

/**
 * Returns a thin-stroke SVG string for the named icon.
...
export function icon(name, size = 20) {
  ...
  return `<svg width="${size}" height="${size}" viewBox="0 0 24 24" ${S} aria-hidden="true">${inner}</svg>`;
}

/**
 * Returns an icon wrapped in a glassmorphism pill container.
 * @param {string} name    - icon key
 * @param {number} size    - icon size (default 20)
 * @param {'green'|'white'|'default'} variant
 */
export function iconGlass(name, size = 20, variant = 'green') {
  return `<div class="icon-glass icon-glass--${variant}" aria-hidden="true">${icon(name, size)}</div>`;
}
